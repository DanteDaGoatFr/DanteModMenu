...
function DiscordLib:Window(text)
    ...
    MainFrame.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    TopFrame.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    TopFrameHolder.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    Title.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    CloseBtn.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
    ...
    CloseIcon.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
    ...
    MinimizeBtn.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
    ...
    MinimizeIcon.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
    ...
    Userpad.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    UserIcon.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    UserImage.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    UserCircleImage.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    UserName.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    UserTag.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    ServersHoldFrame.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    ServersHold.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    SettingsOpenBtn.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
    ...
    SettingsOpenBtnIco.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
    ...
    local ColorChangeBtn = Instance.new("TextButton")
    local ColorChangeBtnCorner = Instance.new("UICorner")
    ...
    SettingsFrame.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    Settings.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    SettingsHolder.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    CloseSettingsBtn.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
    ...
    CloseSettingsBtnCircle.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
    ...
    CloseSettingsBtnIcon.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
    ...
    CloseSettingsBtn.MouseEnter:Connect(function()
        CloseSettingsBtnCircle.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    end)
    ...
    TextLabel.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    UserPanel.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    UserPanel.Position = UDim2.new(0.365638763, 0, 0.130666673, 0)
    UserPanel.Size = UDim2.new(0, 362, 0, 164)

    UserSettingsPad.Name = "UserSettingsPad"
    UserSettingsPad.Parent = UserPanel
    UserSettingsPad.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    UsernameText.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    UserSettingsPadUserTag.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    UserSettingsPadUser.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    UserSettingsPadTag.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    EditBtn.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
    ...
    EditBtn.MouseEnter:Connect(function()
        TweenService:Create(
            ...
            {BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)}
        ):Play()
    end)
    ...
    local ColorChangeBtn

    local function createColorChangeBtn()

        ColorChangeBtn = Instance.new("TextButton")
        ColorChangeBtn.Name = "ColorChangeBtn"
        ColorChangeBtn.Parent = UserSettingsPad
        ColorChangeBtn.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
        ColorChangeBtn.Position = UDim2.new(0.597671914, 0, 1.432142866, 0) 
        ColorChangeBtn.Size = UDim2.new(0, 120, 0, 30) 
        ColorChangeBtn.Font = Enum.Font.Gotham
        ColorChangeBtn.Text = "Change Color"
        ColorChangeBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
        ColorChangeBtn.TextSize = 14.000
        ColorChangeBtn.AutoButtonColor = false

        local ColorChangeBtnCorner = Instance.new("UICorner")
        ColorChangeBtnCorner.CornerRadius = UDim.new(0, 3)
        ColorChangeBtnCorner.Name = "ColorChangeBtnCorner"
        ColorChangeBtnCorner.Parent = ColorChangeBtn

        ColorChangeBtn.MouseEnter:Connect(function()
            TweenService:Create(
                ColorChangeBtn,
                TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                {BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)}
        ...
        ColorChangeBtn.MouseLeave:Connect(function()
            TweenService:Create(
                ColorChangeBtn,
                TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                {BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)}
    ...
    createColorChangeBtn()

    UserPanelUserIcon.Name = "UserPanelUserIcon"
    UserPanelUserIcon.Parent = UserPanel
    UserPanelUserIcon.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    UserPanelUserImage.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    UserPanelUserCircle.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    ChangeAvatarText.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    SearchIcoFrame.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    SearchIco.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    UserPanelUserIcon.MouseButton1Click:Connect(function()
        ...
        NotificationHolder.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
        ...
        AvatarChange.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
        ...
        UnderBar.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
        ...
        UnderBarFrame.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
        ...
        Text1.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
        ...
        Text2.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
        ...
        TextBoxFrame.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
        ...
        TextBoxFrame1.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
        ...
        AvatarTextbox.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
        ...
        ChangeBtn.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
        ...
        CloseBtn2.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
        ...
        Close2Icon.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
        ...
        CloseBtn1.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
        ...
        ResetBtn.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
    ...
    UserPanelUserTag.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    UserPanelUser.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    UserPanelTag.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    LeftFrame.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    MyAccountBtn.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
    ...
    MyAccountBtnTitle.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
    ...
    SettingsTitle.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    DiscordInfo.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    CurrentSettingOpen.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    ColorChangeBtn.MouseButton1Click:Connect(function()
    local NotificationHolder = Instance.new("TextButton")
    NotificationHolder.Name = "NotificationHolder"
    NotificationHolder.Parent = SettingsHolder
    NotificationHolder.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ...
    local ColorChange = Instance.new("Frame")
    local ColorChangeCorner = Instance.new("UICorner")
    local Text1 = Instance.new("TextLabel")
    local Text2 = Instance.new("TextLabel")
    local TextBoxFrame = Instance.new("Frame")
    local TextBoxFrameCorner = Instance.new("UICorner")
    ...
    ColorChange.Parent = NotificationHolder
    ColorChange.AnchorPoint = Vector2.new(0.5, 0.5)
    ColorChange.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
    ColorChange.ClipsDescendants = true
    ColorChange.Position = UDim2.new(0.513071597, 0, 0.4746176, 0)
    ColorChange.Size = UDim2.new(0, 0, 0, 0)
    ColorChange.BackgroundTransparency = 1
    
    ColorChange:TweenSize(UDim2.new(0, 346, 0, 198), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .2, true)
    TweenService:Create(
        ColorChange,
        TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
        {BackgroundTransparency = 0}
    ...
    ColorChangeCorner.CornerRadius = UDim.new(0, 5)
    ColorChangeCorner.Name = "ColorChangeCorner"
    ColorChangeCorner.Parent = ColorChange

    Text1.Name = "Text1"
    Text1.Parent = ColorChange
    Text1.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
    Text1.BackgroundTransparency = 1.000
    Text1.Position = UDim2.new(-0.000594122568, 0, 0.0202020202, 0)
    Text1.Size = UDim2.new(0, 346, 0, 68)
    Text1.Font = Enum.Font.GothamSemibold
    Text1.Text = "Change color"
    Text1.TextColor3 = Color3.fromRGB(255, 255, 255)
    Text1.TextSize = 20.000

    Text2.Name = "Text2"
    Text2.Parent = ColorChange
    Text2.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
    Text2.BackgroundTransparency = 1.000
    Text2.Position = UDim2.new(-0.000594122568, 0, 0.141587839, 0)
    Text2.Size = UDim2.new(0, 346, 0, 63)
    Text2.Font = Enum.Font.Gotham
    Text2.Text = "Enter hex color code:"
    Text2.TextColor3 = Color3.fromRGB(171, 172, 176)
    Text2.TextSize = 14.000

    TextBoxFrame.Name = "TextBoxFrame"
    TextBoxFrame.Parent = ColorChange
    TextBoxFrame.AnchorPoint = Vector2.new(0.5, 0.5)
    TextBoxFrame.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
    TextBoxFrame.Position = UDim2.new(0.49710983, 0, 0.560606062, 0)
    TextBoxFrame.Size = UDim2.new(0, 319, 0, 38)
    ...
    HexTextbox.Parent = TextBoxFrame1
    HexTextbox.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
    HexTextbox.BackgroundTransparency = 1.000
    HexTextbox.Position = UDim2.new(0, 0, 0, 0)
    HexTextbox.Size = UDim2.new(0, 317, 0, 36)
    HexTextbox.Font = Enum.Font.Gotham
    HexTextbox.Text = ""
    HexTextbox.TextColor3 = Color3.fromRGB(193, 195, 197)
    HexTextbox.TextSize = 14.000

    ChangeBtn.Name = "ChangeBtn"
    ChangeBtn.Parent = ColorChange
    ChangeBtn.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
    ChangeBtn.Position = UDim2.new(0.749670506, 0, 0.823232353, 0)
    ChangeBtn.Size = UDim2.new(0, 76, 0, 27)
    ChangeBtn.Font = Enum.Font.Gotham
    ...
    ChangeBtn.MouseButton1Click:Connect(function()
    local hexColor = HexTextbox.Text
      
    if #hexColor == 6 and tonumber(hexColor, 16) ~= nil then
        local r = tonumber(hexColor:sub(1, 2), 16)
        local g = tonumber(hexColor:sub(3, 4), 16)
        local b = tonumber(hexColor:sub(5, 6), 16)
        print("Original Color:", r, g, b)
        
        local function adjustColor(color, adjustments)
        
            local r = math.max(math.min(color.R + adjustments.R, 255), 0)
            local g = math.max(math.min(color.G + adjustments.G, 255), 0)
            local b = math.max(math.min(color.B + adjustments.B, 255), 0)
            
            print("Adjusted Color:", r, g, b)
            return Color3.fromRGB(r, g, b)
        end



        local colorLight = Color3.fromRGB(r, g, b)
        local colorDarkDiff = adjustColor(colorLight, { R = -4, G = -4, B = -4 }) 
        local colorServDiff = adjustColor(colorLight, { R = -2, G = -2, B = -2 }) 
        local colorChanDiff = adjustColor(colorLight, { R = -6, G = -6, B = -6 }) 

        print("Dark Color:", colorDark.R, colorDark.G, colorDark.B)
        print("Serv Color:", colorServ.R, colorServ.G, colorServ.B)
        print("Chan Color:", colorChan.R, colorChan.G, colorChan.B)
    ...
    CloseBtn.Name = "CloseBtn"
    CloseBtn.Parent = ColorChange
    CloseBtn.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
    CloseBtn.BackgroundTransparency = 1.000
    CloseBtn.Position = UDim2.new(0.898000002, 0, 0, 0)
    ...
    CloseIcon.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
    CloseIcon.BackgroundTransparency = 1.000
    CloseIcon.Position = UDim2.new(-0.0384615399, 0, 0.312910825, 0)
    CloseIcon.Size = UDim2.new(0, 25, 0, 25)
    CloseIcon.Image = "http://www.roblox.com/asset/?id=6035047409"
    CloseIcon.ImageColor3 = Color3.fromRGB(119, 122, 127)

    CloseBtn.MouseButton1Click:Connect(function()
        ColorChange:TweenSize(UDim2.new(0, 0, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .2, true)
        TweenService:Create(
            ColorChange,
            TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
            { BackgroundTransparency = 1 }
    ...
    HexTextbox:GetPropertyChangedSignal("Text"):Connect(function()
        HexTextbox.Text = HexTextbox.Text:gsub("[^%x]", ""):sub(1, 6)
    end)
    ...
    EditBtn.MouseButton1Click:Connect(function()
        ...
        UserChange.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
        ...
        UsernameTextbox.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
        ...
        Seperator.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
        ...
        HashtagLabel.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
        ...
        TagTextbox.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
    ...
    function DiscordLib:Notification(titletext, desctext, btntext)
        ...
        NotificationHolderMain.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
        ...
        Notification.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
        ...
        AlrightBtn.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
    ...
    function ServerHold:Server(text, img)
        ...
        Server.BackgroundColor3 = Color3.fromRGB(colorServ.R, colorServ.G, colorServ.B)
        ...
        ServerIco.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorLight.G, colorLight.B)
        ...
        ServerFrame.BackgroundColor3 = Color3.fromRGB(colorServ.R, colorServ.G, colorServ.B)
        ...
        ServerFrame1.BackgroundColor3 = Color3.fromRGB(colorServ.R, colorServ.G, colorServ.B)
        ...
        ServerFrame2.BackgroundColor3 = Color3.fromRGB(colorServ.R, colorServ.G, colorServ.B)
        ...
        ServerTitleFrame.BackgroundColor3 = Color3.fromRGB(colorServ.R, colorServ.G, colorServ.B)
        ...
        ServerContentFrame.BackgroundColor3 = Color3.fromRGB(colorServ.R, colorServ.G, colorServ.B)
        ...
        ChannelTitleFrame.BackgroundColor3 = Color3.fromRGB(colorChan.R, colorChan.G, colorChan.B)
        ...
        ChannelContentFrame.BackgroundColor3 = Color3.fromRGB(colorChan.R, colorChan.G, colorChan.B)
        ...
        function ChannelHold:Channel(text)
            ...
            ChannelBtn.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
            ...
            ChannelBtn.MouseButton1Click:Connect(function()
                ...
                for i, v in next, ServerChannelHolder:GetChildren() do
                    if v.ClassName == "TextButton" then
                        v.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
            ...
            function ChannelContent:Button(text,callback)
                ...
                Button.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
            ...
            function ChannelContent:Toggle(text,default,callback)
                ...
                Toggle.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
                ...
                ToggleFrame.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
            ...
            function ChannelContent:Slider(text, min, max, start, callback)
                ...
                Slider.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
                ...
                SliderFrame.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
                ...
                CurrentValueFrame.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
                ...
                ValueBubble.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
                ...
                SquareBubble.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
            ...
            function ChannelContent:Dropdown(text, list, callback)
                ...
                DropdownFrameOutline.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
                ...
                DropdownFrame.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
                ...
                DropdownFrameMainOutline.BackgroundColor3 = Color3.fromRGB(colorServ.R, colorServ.G, colorServ.B)
                ...
                DropdownFrameMain.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
                ...
                for i,v in next, list do
                    ...
                    Item.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
                    ...
                    ItemText.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
            ...
            function ChannelContent:Colorpicker(text, preset, callback)
                ...
                ColorpickerFrameOutline.BackgroundColor3 = Color3.fromRGB(colorLight.R, colorLight.G, colorLight.B)
                ...
                ColorpickerFrame.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
                ...
                Color.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
            ...
            function ChannelContent:Textbox(text, placetext, disapper, callback)
                ...
                TextboxFrameOutline.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
            ...
            function ChannelContent:Label(text)
                ...
                Label.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
            ...
            function ChannelContent:Bind(text, presetbind, callback)
                ...
                Keybind.BackgroundColor3 = Color3.fromRGB(colorDark.R, colorDark.G, colorDark.B)
...
local window = DiscordLib:Window("Dante's Mod Menu")

local playerTab = window:Server("Player", "")

local speedSection = playerTab:Channel("Speed")

local defaultSpeed = 16

local speedInput = speedSection:Textbox("Speed", "Default " .. defaultSpeed, true, function(newSpeed)
...
speedSection:Button("Reset Speed", function()
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = defaultSpeed
    speedInput:Set(defaultSpeed)
end)

local jumpSection = playerTab:Channel("Jump")

local defaultJumpHeight = 7.2
local defaultGravity = 196.2

local jumpInput = jumpSection:Textbox("Jump Height", "Default " .. defaultJumpHeight, true, function(newHeight)
    newHeight = tonumber(newHeight)
    if newHeight then
        game.Workspace.Gravity = defaultGravity / newHeight
    else
        warn("Invalid jump height value entered!")
    end
end)

jumpSection:Button("Reset Jump Height", function()
    game.Workspace.Gravity = defaultGravity
    jumpInput:Set(defaultJumpHeight)
end)

local flySection = playerTab:Channel("Fly")
        ...
        if enabled then
            ...
            local function updateVelocity()
                ...
                if keysPressed.W then
                    velocity = velocity + (camera.CFrame.LookVector * Vector3.new(1, 0, 1)).unit * flightSpeed
                end
                if keysPressed.S then
                    velocity = velocity - (camera.CFrame.LookVector * Vector3.new(1, 0, 1)).unit * flightSpeed
                end
                if keysPressed.A then
                    velocity = velocity - (camera.CFrame.RightVector * Vector3.new(1, 0, 1)).unit * flightSpeed
                end
...
flySection:Toggle("Fly", flyEnabled, function(enabled)
    toggleFly(enabled)
end)

local flySpeedInput = flySection:Textbox("Flight Speed", "Default 50", tostring(defaultFlightSpeed), function(newSpeed)
    flightSpeed = tonumber(newSpeed)
    if not flightSpeed then
        warn("Invalid fly speed value entered!")
    end
end)

flySection:Button("Reset Flight Speed", function()
    flightSpeed = defaultFlightSpeed
    flySpeedInput:Set(tostring(defaultFlightSpeed))
end)




local teleportServ = window:Server("Teleport", "")

local teleportChannel = teleportServ:Channel("Teleport to Player")


local dropdown = teleportChannel:Dropdown("Teleport to Player", {}, function(selectedPlayer)
